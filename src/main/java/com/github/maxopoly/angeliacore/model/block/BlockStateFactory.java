...
public class BlockStateFactory {
	...
	private static void initialize() {
		...
		multiRegister(new VariableBlockState(SpecialRailBlockState.class, 157, 0.7f, "activator_rail", "Activator Rail"));
	...
	private static void registerWoodVariations(int id, float hardness, String texPackSuffix, String niceNameSuffix) {
		...
		register(new SolidStaticBlockState(id, (byte) 1, hardness, "spruce" + texPackSuffix, "Spruce" + niceNameSuffix));
		register(new SolidStaticBlockState(id, (byte) 2, hardness, "birch" + texPackSuffix, "Birch" + niceNameSuffix));
		register(new SolidStaticBlockState(id, (byte) 3, hardness, "jungle" + texPackSuffix, "Jungle" + niceNameSuffix));
		register(new SolidStaticBlockState(id, (byte) 4, hardness, "acacia" + texPackSuffix, "Acacia" + niceNameSuffix));
		register(new SolidStaticBlockState(id, (byte) 5, hardness, "dark_oak" + texPackSuffix, "Dark Oak" + niceNameSuffix));
	}
