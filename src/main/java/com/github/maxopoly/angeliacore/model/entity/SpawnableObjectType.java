...
/**
 * On packet level minecraft differentiates between living entities and 'objects' like boats or llama spit. This
 * enum includes all of these objects that can be spawned, together with their id. Note that these ids are completly
 * separate from living entity ids, even though the gaps might make you think otherwise
 *
 */
public enum SpawnableObjectType {
	...
	ITEMSTACK(2),
	AREA_EFFECT_CLOUD(3), //the clouds spawned by lingering potions
	MINECART(10),  //includes all minecart variations (tnt/chest/furnace)
	ACTIVATED_TNT(50), //tnt in it's block form is deleted when primed and turns into one of these pseduo entities
	...
	FIREWORK(76),
	LEASH_KNOT(77), //the thing that appear when tying a horse to a fence
	ARMOR_STAND(78),
	EVOCATION_FANG(79),
	FISHING_HOOK(90), //the bopper at the end of the line, which is floating in the water
	SPECTRAL_ARROW(91), //if someone gets the chance, please ask jeb what he was thinking when making these a separate thing
