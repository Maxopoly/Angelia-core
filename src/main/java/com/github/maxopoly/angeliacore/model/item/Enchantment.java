...
public enum Enchantment {
	...
	// sword
	BANE_OF_THE_ARTHROPODS((short) 18), SMITE((short) 17), SHARPNESS((short) 16), FIRE_ASPECT((short) 20),
	KNOCKBACK((short) 19), LOOTING((short) 21),
	...
	// armor
	PROTECTION((short) 0), FIRE_PROTECTION((short) 1), BLAST_PROTECTION((short) 3), PROJECTILE_PROJECTION((short) 4),
	THORNS((short) 7),
